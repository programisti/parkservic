...
var bi=function(b){
    ...
    h.title="RaphaÃ«l Colour Picker";
...
function bm(a,b,c){
    function d(){
        var g=Array[e].slice.call(arguments,0),h=g[v]("â–º"),i=d.cache=d.cache||{},j=d.count=d.count||[];
...
return c
    ...
    return function(){
        throw new Error("RaphaÃ«l: you are calling to method â€œ"+a+"â€ of removed object")
        }
    };
...
k.clear=function(){
    ...
    (this.desc=bG("desc"))[l](g.createTextNode("Created with RaphaÃ«l"));
    a[l](this.desc);
